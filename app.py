...
# Footer
st.markdown("---")
st.markdown('<span style="color: #34495e; font-size: 0.9em;">Developed by Ehsan Arshad | Powered by Streamlit | Last Updated: September 28, 2025, 12:18 PM PKT</span>', unsafe_allow_html=True)
